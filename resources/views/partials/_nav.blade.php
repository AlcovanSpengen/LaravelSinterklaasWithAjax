<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="/">Sinterklaas Blog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="{{ Request::is('blog') ? "nav-item active" : "nav-item" }}">
        <a class="nav-link" href="/blog">Wishlists</a>
      </li>
    ...
    <ul class="navbar-nav navbar-right">
      ...
      @else
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="{{ route('lists.index') }}">My Wishlists</a>
          <a class="dropdown-item" href="#">Action</a>
          <a class="dropdown-item" href="#">Gedichten</a>
